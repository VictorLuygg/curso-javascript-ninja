...
*/
var pessoa = {nome: "Victor", sobrenome: "Luygg", sexo: "masculino", idade: 27, altura: 1.77, peso: 80, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto(); // Ola! Meu nome e Victor Luygg!
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura(); // Minha altura e 1.77m.
...
*/
pessoa.caminhouQuantosMetros; // 333
...
pessoa.apresentacao = function() {
    if( pessoa.sexo === "masculino" ) var art = "o "; else var art = "a ";

    if( pessoa.idade > 1 ) var age = " anos, "; else var age = " ano, ";
